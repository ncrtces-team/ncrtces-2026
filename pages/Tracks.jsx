...
const Tracks = () => {
  ...
  const tracks = [
    {
      id: "track1",
      title: "Track I: Climate Change — Extreme Weather and Environment",
      items: [
        "Climate modelling and simulation",
        "Heatwaves, droughts, cyclones, and flood risk assessment",
    ...
    },
    {
      ...
      items: [
        "Energy-efficient building design and green architecture",
        "Industrial energy optimization techniques",
        "Low-carbon technologies and emissions reduction",
      ],
    },
    {
      id: "track3",
      ...
      items: [
        "Numerical Weather Prediction (NWP) advancements",
        "Big data analytics for weather systems",
        "Decision support systems for agriculture, aviation & disaster response",
      ],
    },
    {
      id: "track4",
      ...
      items: [
        ...
        "Urban sustainability, smart cities & green infrastructure",
      ],
    },
    {
      id: "track5",
      ...
      items: [
        "AI/ML for climate prediction and extreme event detection",
        "AI-driven decision-making in energy, agriculture & sustainability",
    ...
    },
    {
      ...
      items: [
        "High-performance computing (HPC) for climate simulation",
        "Cloud platforms for climate and environmental data",
        "Cybersecurity for environmental data infrastructure",
      ],
    },
    {
      id: "track7",
