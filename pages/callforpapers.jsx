        ...
        <div className="bg-gradient-to-t to-blue-400 from-blue-500 px-[8%] md:px-[15%] py-16 shadow-lg">
          ...
          <section className="text-center mb-12">
            ...
            <p className="text-lg md:text-2xl font-bold mt-3">
              The National Conference on Recent Trends in Climate Change, Energy
              <br />
              and Sustainability (NCRTCES) 2026
            </p>
            <p className="mt-1 text-lg md:text-xl font-bold italic py-2">
              to be held on <br />{" "}
              <span className="font-bold text-yellow-200 underline pb-2">
                27-28 February, 2026
              </span>
              <br /> at <br />
              <span className="font-bold md:text-xl text-yellow-200 underline pb-2">
                Maharaja Surajmal Institute of Technology, C-4, Janakpuri, New
                Delhi, India
              </span>
            </p>
          </section>
          ...
          <article className="bg-white/10 p-6 rounded-lg shadow-md">
            <p className="text-justify text-md md:text-xl pt-3 pb-16 leading-relaxed">
              ...
              provide fresh, creative concepts in this area. It also covers
              Artificial Intelligence trends that promote environmental
              sustainability and effective energy use. The conference brings
              together researchers and application developers from the fields of
              climate change, energy, and sustainability to present their
              original research findings as well as discuss and disseminate
              creative ideas.
            </p>
          </article>
        </div>
